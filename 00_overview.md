...
| # | 家族 | 实例 | 问题 | 目标 | 基准最优值 |
|---|---|---|---|---|---|
| 1 | csp_1d_waescher | Waescher_TEST0005（m=57, L=10000） | 1D 切割下料 | min 辊数 | 28（已证明） |
| 2 | bpp_falkenauer | u120_00（n=120, C=150） | 1D 装箱 | min 箱数 | 48（已证明） |
...
| 6 | cutting_2d_cgcut | cgcut1（7 件，15×10） | 2D guillotine 切割 | max 价值 | 244（已证明，固定朝向） |

## 结果汇总（全部完成后自动填入）

| 家族 | 直接建模 | 列生成 | Benders | 拉格朗日 | LBBD | 基准 | 全部最优? |
|---|---|---|---|---|---|---|---|
| csp_1d_waescher | 28 / 20s / 0.0% | 28 / 25s / 0.02%† | 28 / 25s / 0.02%† | 28 / 40s / 0.45%† | 28 / 90s / 0.0% | 28 | 是（另含 B&P 60s 证明） |
| bpp_falkenauer | 48 / 50s / 0.0% | 48 / 20s / 1.55%† | 48 / 25s / 1.55%† | 48 / 25s / 3.0%† | 48 / 65s / 0.0% | 48 | 是（另含 B&P 20s 证明） |
| scp_beasley | | | | | | | |
...
| cutting_2d_cgcut | 244 / 55s / 0.0% | 244 / 1s / 0.0% | 244 / 1s / 0.0% | 244 / 5s / 0.0% | 244 / 30s / 0.0% | 244 | 是（另含 B&P 1s 证明） |
